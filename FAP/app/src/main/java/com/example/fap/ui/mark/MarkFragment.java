...
public class MarkFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        MarkViewModel markViewModel =
                new ViewModelProvider(this).get(MarkViewModel.class);

        binding = FragmentMarkBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textMark;
        markViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        return root;
    }
